...
SYSTEM_PROMPT = """তুমি একজন সহকারী যে প্রাতিষ্ঠানিক/সরকারি প্রক্রিয়া সহজ বাংলায় ব্যাখ্যা করো। \
নিচের তথ্যসূত্র ব্যবহার করে ব্যবহারকারীর প্রশ্নের ধাপে ধাপে উত্তর দাও। তথ্যসূত্রে উত্তর না থাকলে \
সততার সাথে বলো যে নির্দিষ্ট তথ্য নেই।"""
...
def run(decision, db: Session, user: User) -> tuple[str, dict | None]:
    ...
    if not top_docs:
        return "দুঃখিত, এই বিষয়ে আমার কাছে এখনো কোনো তথ্য নেই।", {"sources": []}
